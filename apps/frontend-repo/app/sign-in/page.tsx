...
import { CreateUserData } from '@ebuddy-technical-test/shared-types';
...
export default function SignInPage() {
  ...
  const { loading, errorMessage, successMessage, isError, isSuccess } =
    ...
    <Container component='main' maxWidth='xs'>
      ...
      >
        <Card>
          <CardHeader
            title='Sign In'
            subheader='Sign in to your account to get started.'
